...
function initialize(a) {
    ...
    if (/Mobile|Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)) {
        ...
        //("#inst_main_body").html("The goal of Hextris is to preventing blocks from going past the outer gray hexagon<br><br>" + (settings.platform != 'mobile' ? 'Use the right and left arrow keys' : 'Tap the left and right sides of the screen') + "  to rotate the Hexagon<br><br>Get 3+ blocks of the same color to touch to clear them and get points<br><br><span style='color:#f1c40f;'>The</span> <span style='color:#e74c3c'>colored</span> <span style='color:#3498db'>edges</span> <span style='color:#2ecc71'>of</span> the outer hexagon indicate remaining time of the current combo streak<br><br> " + (settings.platform == 'mobile' ? 'Speed up the game 2x by tapping the inner hexagon' : "Speed up the game 2x by holding the down arrow"));
        $("#inst_main_body").html("Prevent the blocks from reaching past the outer gray hexagon<br><br>" + (settings.platform != 'mobile' ? 'Right + Left Arrow Keys: ' : 'Tap the left and right sides of the screen: ') + " Rotate Hexagon<br>" + (settings.platform == 'mobile' ? 'Tap inner hexagon: ' : "Down Arrow Key: ") + "Speed up Game<br><br> " + "Get 3+ blocks of the same color to touch to clear them and get points<br><br> <span style='color:#f1c40f;'>The</span> <span style='color:#e74c3c'>colored</span> <span style='color:#3498db'>edge</span> <span style='color:#2ecc71'>of</span> the outer hexagon indicates the remaining time of the current combo streak<br><br> ");
    }
